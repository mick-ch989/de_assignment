...
from pyspark.sql.functions import (
    col, countDistinct, avg, stddev,
    abs as abs_spark, percentile_approx, to_date, count,
)
...
def write_results(df, output_path, output_format="csv"):
    """Write results to CSV or Parquet"""
...
def main():
    ...
    try:
        ...
        # Write results
        write_results(result_df, OUTPUT_PATH, OUTPUT_FORMAT)
